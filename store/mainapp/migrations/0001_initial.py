...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='customer',
            name='wishlist',
            field=models.ManyToManyField(blank=True, to='mainapp.Album', verbose_name='Лист ожидания'),
        ),
        migrations.CreateModel(
            name='CartProduct',
            fields=[
        ...
        migrations.AddField(
            model_name='cart',
            name='products',
            field=models.ManyToManyField(blank=True, related_name='related_cart', to='mainapp.CartProduct', verbose_name='Продукты для корзины'),
        ),
        migrations.CreateModel(
            name='Artist',
            fields=[
                ...
                ('members', models.ManyToManyField(related_name='artist', to='mainapp.Member', verbose_name='Участник')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='album',
            name='artist',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.artist', verbose_name='Исполнитель'),
        ),
        migrations.AddField(
            model_name='album',
            name='media_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.mediatype', verbose_name='Носитель'),
        ),
    ]
