...
* Поиск по сайту по различным критериям (фильтры ,поисковая строка).
...
* Можно доработать админку, сильно не настраивал, не было такой задачи, запросы не оптимизированы(черновой вариант)
